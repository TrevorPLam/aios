...
- `constitution.json` - Behavioral governance rules (replaces DOCUMENT_MAP.md)
- `CHANGELOG.md` - Framework change history
- `CATALOG.md` - **Complete inventory and categorized catalog** (comprehensive system documentation)
- `INDEX.md` - This file
...
- `constitution.json` - Behavioral governance rules (replaces QUICK_REFERENCE.md)
...
- `.repo/CATALOG.md` - **Complete inventory and categorized catalog** (full system documentation)
