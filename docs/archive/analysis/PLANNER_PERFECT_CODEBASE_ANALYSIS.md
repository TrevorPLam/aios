...
1. **MEDIUM - Memory Leak Risk** (PlannerScreen:310-314)
...
1. **Silent Failures** (PlannerScreen:256, ProjectDetailScreen:70)
...
1. **No Validation Before Save** (TaskDetailScreen:143-180)
...
1. **Repeated Database Queries** (PlannerScreen:268)
...
1. **applySorting Function** (68 lines with repetitive logic)
...
1. **Statistics Chips** (5 nearly identical View structures)
...
1. **Week Calculation Off-By-One** (TaskDetailScreen:73-75)
...
1. **Missing Cascade Delete** (ProjectDetailScreen)
...
1. **Dependency Tracking** (PlannerScreen)
...
1. **Project Integration** (PlannerScreen)
...
1. **Sort Logic Duplication** (Lines 437-504, 68 lines)
...
1. **Nested Ternary Operators** (Multiple locations)
