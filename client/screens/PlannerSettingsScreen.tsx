...
export default function PlannerSettingsScreen() {
  ...
  const toggleEnabled = useCallback(async () => {
    ...
    const isEnabled = settings.enabledModules.includes("planner");
    const enabledModules = isEnabled
      ? settings.enabledModules.filter((m) => m !== "planner")
      : [...settings.enabledModules, "planner"];
        ...
        >
          <View style={styles.settingRow}>
            <View style={styles.settingInfo}>
              ...
              <ThemedText type="body">Enable Planner</ThemedText>
            </View>
            <Switch
              value={isEnabled}
