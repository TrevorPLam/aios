...
- T-071: Documented meeting link validation behavior in API docs. (2026-01-21)
...
- **Status**: READY
- **Context**:
  - Meeting link validation is documented but lacks concrete payload examples
  - API consumers need ready-to-copy request/response samples
- **Acceptance Criteria**:
  - [ ] Add sample request payloads for meeting link fields on event endpoints
  - [ ] Add sample response payloads showing normalized meeting link data
- **References**: docs/technical/API_DOCUMENTATION.md
- **Dependencies**: None
- **Effort**: S
